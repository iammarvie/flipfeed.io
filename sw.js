const CACHE="flipfeed-v3";
const ASSETS=["./","./index.html","./style.css","./responsive.css","./app.js","./manifest.webmanifest","./icons/icon.svg","./vendor/jszip.min.js","./vendor/sql-wasm.js","./vendor/sql-wasm.wasm"];
